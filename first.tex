...
Для поиска подстрок необходимо использовать методы \lstinline|find()|, который ведет поиск слева направо, и \lstinline|rfind()|, который ищет справа налево. На вход методы принимают подстроку типа \lstinline|std::string| и возвращают индекс начальной позиции этой подстроки. Если данной подстроки нет, то возвращается \lstinline|string::npos|.
